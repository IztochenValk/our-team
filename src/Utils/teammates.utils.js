...
export async function getTeammates(array) {
    try {
        ...
        data.forEach((teammate)=>{
            array.push(new Teammate(teammate.name, teammate.exp, teammate.poste, teammate.img, teammate.technos))
        })
    } catch (error) {
...
export function showTeammates(array) {
